import { Button, Checkbox, Flex, HStack, Box, IconButton } from '@chakra-ui/react';
...
export const companyColumnsReportingStatus = ({
                                 data,
                                 handleSortChange,
                                 activeSortKey,
                                 handleFilterChange,
      ...
      render: (_: never, rowIndex: number) => {
        ...
        return (
          ...
          {/* <Button 
            ...
            onClick={() => navigate(`/${userRole === "user-admin" ? "admin" : userRole}/reporting-status/company/${companyItem?.id}`)}
          >
            Submissions
          </Button> */}
          <IconButton
    ...
    [
      {
        ...
        render: (_: never, rowIndex: number) => {
          ...
          return <CompanyActionButton data={companyItem} />;
        }
      }] : [])
]};
