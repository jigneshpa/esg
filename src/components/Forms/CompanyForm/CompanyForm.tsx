...
import { Box, FormControl, FormErrorMessage, FormLabel, Icon, Input, Stack, Text, VStack } from '@chakra-ui/react';
...
const CompanyForm = forwardRef(({ onSubmit, company }: IEditCompanyTypeFormProps, ref: ForwardedRef<any>) => {
